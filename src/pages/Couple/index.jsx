...
const Couple = () => {
  return (
        <section className={ `d-flex flex-column justify-content-center align-items-center text-center ` } style={{ zIndex:10, height:'95%' }}>
            <div className={ `container overflow-scroll h-75 text-end  py-4 px-4 mx-5 ${ style.borderRadius } ${ style.bgWhiteTrasnparent } py-5 text-black` }>
